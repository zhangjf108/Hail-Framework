...
/**
 * Class Selectel
 * $ composer require argentcrusade/selectel-cloud-storage:~1.1"
 *
 * @package Hail\Filesystem\Adapter
 */
class Selectel implements AdapterInterface
{
    ...
    {
        if (!isset($config['username'], $config['password'], $config['container'], $config['container_url'])) {
            throw new \InvalidArgumentException('Selectel config not defined');
        }
